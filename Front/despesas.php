...
<head>
    ...
    <style>
        * {
        ...
        .despesa-actions .btn-edit:hover {
            border-color: rgba(99, 102, 241, 0.4);
            color: #818cf8;
        }

        .despesa-actions .btn-delete:hover {
            border-color: rgba(239, 68, 68, 0.4);
            color: #f87171;
        }
...
<body>
    ...
    <nav class="navbar-custom">
        <div class="container d-flex align-items-center justify-content-between" style="max-width:960px;">
            ...
            <div class="d-flex align-items-center gap-4">
                ...
                <a href="ganhos.php" class="nav-link-custom">Ganhos</a>
                <a href="despesas.php" class="nav-link-custom active">Despesas</a>
    ...
    <div class="main-container">
        ...
        <!-- ===== ALERT ===== -->
        <div id="despesa-alert" class="despesa-alert"></div>
        ...
        <div class="form-card">
            ...
            <form id="form-despesa" onsubmit="submitDespesa(event)">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <button type="submit" class="btn-despesa" id="btn-submit">
        ...
        <div class="despesas-list">
            <div class="despesas-list-header">
        ...
        <div class="modal-card">
            ...
            <form id="form-edit" onsubmit="submitEdit(event)">
                ...
                <div class="d-flex gap-3 justify-content-end">
                    ...
                    <button type="submit" class="btn-despesa">
    ...
    <script>
        ...
        function showAlert(msg, type) {
            const el = document.getElementById('despesa-alert');
            el.textContent = msg;
            el.className = 'despesa-alert ' + type;
        ...
        <div class="despesa-item">
            <div class="despesa-icon"><i class="bi bi-arrow-up-right"></i></div>
            ...
            <div class="despesa-valor">- ${formatMoney(d.valor)}</div>
        ...
        async function submitDespesa(e) {
            ...
            const res = await criarDespesa(descricao, valor, data, fixo, USUARIO_ID);
        ...
        async function submitEdit(e) {
            ...
            const res = await atualizarDespesa(id, descricao, valor, data, fixo);
