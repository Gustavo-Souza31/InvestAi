...
<body>
    ...
    <?php $nav_active = 'ganhos'; include '../../components/navbar.php'; ?>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex gap-2">
                            <select id="ganho-categoria" class="form-select" required>
    ...
    <script src="../../../api/ganhos/read.js?v=<?= time() ?>"></script>
    <script src="../../../api/ganhos/render.js?v=<?= time() ?>"></script>
    <script src="../../../api/ganhos/create.js?v=<?= time() ?>"></script>
    <script src="../../../api/ganhos/update.js?v=<?= time() ?>"></script>
    <script src="../../../api/ganhos/delete.js?v=<?= time() ?>"></script>
