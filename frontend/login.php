...
if (isset($_SESSION['usuario_id'])) {
    header('Location: public/pages/user/dashboard.php');
    exit;
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <!-- Modais legais (Política de Privacidade e Termos de Uso) -->
    <?php $hide_footer = true; include 'public/components/footer.php'; ?>
